...
//                 <StockPriceCard symbol={symbol} price={price} change={change} loading={loading} />
//                 {/* NewsFeed directly under price card */}
//                 <div className="mt-8">
//                   <NewsFeed news={news} loading={loading} />
//                 </div>
//               </div>
...
//             {/* First grid row */}
//             <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
//               {/* Stock Price card and NewsFeed (left column) */}
//               <div className="lg:col-span-1 flex flex-col gap-8">
//                 {/* Set explicit height for StockPriceCard */}
//                 <div className="h-[200px]">
//                   <StockPriceCard symbol={symbol} price={price} change={change} loading={loading} />
//                 </div>
//                 {/* Set explicit height for NewsFeed */}
//                 <div className="h-[320px]">
//                   <NewsFeed news={news} loading={loading} />
//                 </div>
//               </div>
//               {/* Chart card (right column, matches left column total height) */}
//               <div className="lg:col-span-2">
